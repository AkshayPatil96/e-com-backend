    ...
    url: {
      ...
      validate: {
        validator: function (v: string) {
          ...
          const s3PathRegex =
            /^[a-zA-Z0-9\-_/]+\.(jpg|jpeg|png|gif|webp|avif)$/i;
        ...
        message:
          "Invalid image URL or S3 path. Must be a valid URL or end with jpg, jpeg, png, gif, webp, or avif",
      },
    },
    alt: {
      type: String,
 ...
 */
export const BaseAddressSchema = new Schema<IAddress>(
  {
    street: {
      type: String,
    ...
    type: {
      ...
      enum: {
        ...
        message:
          "Address type must be one of: home, work, billing, shipping, business, pickup, return, other",
      },
      default: "home",
    },
    label: {
 ...
 */
export const SellerAddressSchema = new Schema(
  {
    type: {
      type: String,
